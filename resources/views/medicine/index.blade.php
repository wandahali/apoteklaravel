...
@endif
    <div class="container mt-3">
         <form action="{{ route('medicine.home') }}" method="GET" class="d-flex" style="width: 350px; display:flex; margin-bottom:-30px;" >
            ...
            @if(request()->has('cari'))
                <a class="btn btn-secondary btn-info" href="{{ route('medicine.home') }}" >Hapus Pencarian</a>
            @endif
    </div>
    @csrf
</form>
